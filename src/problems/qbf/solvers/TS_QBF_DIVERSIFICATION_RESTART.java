 ...
 */
public class TS_QBF_DIVERSIFICATION_RESTART extends AbstractTS<Integer> {
     ...
     */
    public TS_QBF_DIVERSIFICATION_RESTART(Integer tenure, Integer time, String filename, int restartLimit) throws IOException {
    ...
    private void restartSearch() {
        ...
        sol = new Solution<>(createEmptySol());
    ...
    public static void main(String[] args) throws IOException {
        ...
        TS_QBF_DIVERSIFICATION_RESTART tabusearch = new TS_QBF_DIVERSIFICATION_RESTART(10, 10000, "instances/kqbf/kqbf200", 900);
